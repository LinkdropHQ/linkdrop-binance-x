...
var tokenContract = require('./token-contract')
...
(function () {
  ...
  var blocksToCreate = 9

  var blockNumber = testBlock.number - blocksToCreate
...
eth.sendTransaction = function (obj, callback) {
  callback()
}

eth.contract = function () {
  return {
    at: function (tokenAddress) {
