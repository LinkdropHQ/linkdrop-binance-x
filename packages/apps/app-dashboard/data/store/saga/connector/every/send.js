...
const generator = function * ({ payload }) {
  try {
    yield put({ type: 'CONNECTOR.SET_STATUS', payload: { status: 'initial' } })
    ...
    // right now it will send imediately funds
    yield put({ type: 'CONNECTOR.SET_STATUS', payload: { status: 'finished' } })
    // }
  } catch (e) {
    console.error(e)
  }
